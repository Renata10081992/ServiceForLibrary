...
public class PersonController {
    ...
    @GetMapping("/{id}")
    public String getIdPerson(@PathVariable("id") int id, Model model) {
    ...
    public String newPerson(Model model) {
        model.addAttribute("newPerson", new Person());                 //create1
        return "person/new";
    }
    ...
    public String createPerson(@ModelAttribute("newPerson") @Valid Person person,
        ...
        if (bindingResult.hasErrors())
            return "person/new";
        personDao.createPerson(person);                                            //create2
    ...
    public String updatePerson(@ModelAttribute("editPerson") @Valid Person person, BindingResult bindingResult,
        ...
        return "redirect:person/persons";                                              //update2
    }

    @DeleteMapping("/{id}")
    public String delete(@PathVariable("id") int id) {
        personDao.deletePerson(id);
        return "redirect:person/persons";                                              //delete
    }
}
